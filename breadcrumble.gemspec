...
Gem::Specification.new do |gem|
  ...
  gem.description   = "A breadcrumbs plugin for Ruby on Rails 4.x and 5.0."
  gem.summary       = "Breadcrumble is a simple breadcrumb navigation plugin for Ruby on Rails 4.x and 5.0."
